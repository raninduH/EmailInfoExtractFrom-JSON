...
from email_filtering_and_info_generation.services import send_suggestion
    ...
    for new_email_msg in new_email_msg_array:
        ...
        if new_email_msg["type"] == "client":
            ...
            try:
                ...
                print("Excepteion :", e)
                print("oooooooooooooooooooooooooooooooooooooooooooooooo", email_no-1, " email number is skipped from identifyinh suggestions oooooooooooooooooooooooooooooooooooooooooooooooooooooooooooo")   

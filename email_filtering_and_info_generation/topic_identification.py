...
import os
from email_filtering_and_info_generation.services import getProductsList
...
retry_policy = tenacity.retry(
    retry=tenacity.retry_if_exception_type(genai.types.generation_types.StopCandidateException),
